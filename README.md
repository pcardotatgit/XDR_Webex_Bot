...
It can be used for anything other similar purposes for sure, but my goal was to have this component I can attach to any XDR tenant in 5 minutes and use it as an advanced alerting system for XDR.
...
Any click on buttons will be catpured by this Bot and will trigger XDR workflows thanks to webhooks.
...
And for all this, having the capability to pass variable from the webex chat to the XDR workflows that are triggered.
